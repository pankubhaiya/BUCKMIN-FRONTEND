          ...
          <div className="popup-content bg-white  rounded-lg relative">
            ...
            <div className="flex w-full h-auto">
              ...
              <div className=" w-full items-center m-auto mt-24 ml-10">
                ...
                <div className="calendar"><SimpleReactCalendar activeMonth={new Date()} /></div>
          ...
          <div className="popup-content bg-white  rounded-lg relative">
            ...
            <div className="flex w-full h-auto">
              ...
              <div className=" w-full items-center m-auto mt-24 ml-10">
               ...
               <p className="text-[#344054] text-sm font-semibold mb-2">Team member</p>
               <div> <select className=" p-2 mb-6 w-80  border rounded-md" name="" id="">
                <option value="team" > <IoIosPerson/>Select team member</option>
              </select></div>
              
                
                <button className="btn bg-[#FF5151] text-white mt-2 w-24">{selectedOption === "addMember"? "Confrim":"Next"}</button>
              </div>
            </div>
          </div>
        </div>
